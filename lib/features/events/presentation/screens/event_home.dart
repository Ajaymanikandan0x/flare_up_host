import 'package:flare_up_host/dependency_injector.dart';
...
import '../bloc/cubit/video_player_cubit.dart';
import '../widgets/booking_container.dart';
import '../widgets/date_container.dart';
import '../widgets/expandable_text.dart';
import '../widgets/image_shimmer_loading.dart';
...
class _EventHomeState extends State<EventHome> {
  ...
  void didChangeDependencies() {
    ...
    if (!_initialized) {
      event = ModalRoute.of(context)!.settings.arguments as HostEventEntities;
      _initialized = true;
    }
  }
            ...
            body: Stack(
              children: [
                Stack(
                  children: [
                    CustomVideoWidget(
                      videoUrl: _formatCloudinaryUrl(event.promoVideo),
  ...
  String _formatCloudinaryUrl(String? url) {
    ...
    if (!url.startsWith('http')) {
      ...
      return '$cloudinaryVideoUrl/event_promo_videos/$videoId.mp4';
    }
    return url;
  }
}
