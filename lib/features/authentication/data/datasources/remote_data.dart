...
class HostRemoteDatasource {
  ...
  HostRemoteDatasource(this._networkService) : dio = _networkService.dio {
  ...
  Future<ApiResponse<HostModelSignIn>> login({
    ...
    return _networkService.safeApiCall(
      ...
      transform: (data) => HostModelSignIn.fromJson(data),
    );
  }

  Future<ApiResponse<HostModelSignup>> signUp({
    required String username,
    ...
    return _networkService.safeApiCall(
      ...
      transform: (data) {
        ...
        return HostModelSignup.fromJson({
          ...data,
          'username': username,
          'fullname': fullName,
          'email': email,
  ...
  Future<ApiResponse<HostModelSignIn>> googleSignIn({
  ...
  Future<ApiResponse<HostModelSignIn>> googleSignUp({
    required String accessToken,
    required String role,
  }) async {
    return _networkService.safeApiCall(
