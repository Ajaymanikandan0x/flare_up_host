...
class HostRepositoryImpl implements AuthRepositoryDomain {
  final HostRemoteDatasource _remoteDatasource;

  HostRepositoryImpl(this._remoteDatasource);
  ...
  @override
  Future<HostEntitySignIn> googleSignIn({required String accessToken}) async {
