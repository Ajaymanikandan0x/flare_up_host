...
abstract class HostProfileRemoteDataSource {
  Future<HostProfileModel> fetchHostProfile(String userId);
  Future<void> updateHostProfile(HostProfileModel userProfile,
...
class HostProfileRemoteDataSourceImpl implements HostProfileRemoteDataSource {
  ...
  HostProfileRemoteDataSourceImpl({
    required this.storageService,
    required this.dio,
  });

  @override
  Future<HostProfileModel> fetchHostProfile(String userId) async {
    try {
